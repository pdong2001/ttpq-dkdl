...
const departLocationList = [
  { id: 0, code: 'tutuc', ten: 'Tự túc' },
  { id: 1, code: 'hcm-nonglam', ten: 'Bến xe buýt Trường Đại học Nông Lâm' },
  {
    id: 2,
    code: 'hcm-bdt',
    ten: 'Cầu Bùi Đình Túy, số 47 Bùi Đình Túy, P.24, Q. Bình Thạnh, Tp.HCM',
  },
];
// thời điểm khởi hành
const timeToStartList = [
  { id: 0, code: 'tutuc', ten: 'Tự túc' },
  { id: 1, code: 'dot1', ten: 'Đợt 1: 19h45 Thứ hai, ngày 08/08/2022' },
  { id: 2, code: 'dot2', ten: 'Đợt 2: 19h45 Thứ ba, ngày 09/08/2022 (Đợt chính thức)' },
  { id: 3, code: 'dot3', ten: 'Đợt 3: 06h00 Thứ tư, ngày 10/08/2022' },
];

// thời điểm về lại nơi xuất phát
const timeToReturnList = [
  { id: 0, code: 'tutuc', ten: 'Tự túc' },
  { id: 1, code: 'dot1', ten: 'Đợt 1: 18h00 Thứ sáu, ngày 12/08/2022' },
  { id: 2, code: 'dot2', ten: 'Đợt 2: 18h00 Chủ nhật, ngày 14/08/2022' },
];
