...
import { Button, Text, Image, GridItem } from '@chakra-ui/react';
...
import EVENT_INFO_1 from '~/assets/event-info/0-dang-hoa.jpg';
import EVENT_INFO_2 from '~/assets/event-info/1-ve-chua.jpg';
import EVENT_INFO_3 from '~/assets/event-info/2-van-nghe.jpg';
import EVENT_INFO_4 from '~/assets/event-info/3-toa-thien.jpg';
import EVENT_INFO_5 from '~/assets/event-info/4-quy-y.jpg';
import EVENT_INFO_6 from '~/assets/event-info/5-dang-hoa.jpg';
import EVENT_INFO_7 from '~/assets/event-info/6-dang-hoa.jpg';
    ...
    <>
      ...
      >
        ...
        <Container
          ...
          mb={10}
        >
          <VStack align={'start'} as={GridItem}>
            <Box mb={{ base: 4, md: 0 }}>
              <FadeInUp>
                <Heading
                  color={'white'}
